...
- Brand skin can alter page-level colors, card rhythm, density, image placement, chips, CTAs, and module layouts. It must not alter protected shell geometry, WeCom capsule behavior, bottom tab behavior, role/journey controls, mobile full-screen behavior, sticky CTA anchoring, or native WeCom replica structure.
