...
- Obtain explicit user acceptance of two to four representative branded screens only after their component manifest and Chrome layout report pass.
...
- In review mode, show the active page's rendered component IDs and layout PASS/FAIL outside the phone.
